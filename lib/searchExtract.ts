...
משימה: חלץ את הנתונים הרלוונטיים על כל דירה והחזר JSON.

עבור כל תוצאה שהיא באמת דירה להשכרה, חלץ:
...
**חשוב:** התעלם מתוצאות שהן לא דירות (מאמרים, פרסומות, תוצאות ריקות).
